			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" id="nama_register_eo" name="nama_register_eo">
						</div>
					</div>
					<div class="form-group">
						<label for="alamat_register_eo" class="control-label col-sm-3">Alamat Penyelenggara :</label>
						<div class="col-sm-9">
							<textarea name="alamat_register_eo" id="alamat_register_eo" cols="30" rows="10" class="form-control"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label for="nama_pj_eo" class="control-label col-sm-3">Nama Penanggung Jawab :</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="nama_pj_eo" name="nama_pj_eo">
						</div>
					</div>
					<div class="form-group">
						<label for="gender_pj_eo" class="control-label col-sm-3">Jenis Kelamin :</label>
						<div class="col-sm-9">
							<label class="radio-inline"><input type="radio" name="gender_pj_eo" id="gender_pj_eo" value="L">Laki - Laki</label>
							<label class="radio-inline"><input type="radio" name="gender_pj_eo" id="gender_pj_eo" value="P">Perempuan</label>
						</div>
					</div>
					<div class="form-group">
						<label for="idno_pj_eo" class="control-label col-sm-3">Nomor KTP/SIM/PASSPOR :</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="idno_pj_eo" name="idno_pj_eo">
						</div>
					</div>
					<div class="form-group">
						<label for="kerja_pj_eo" class="control-label col-sm-3">Pekerjaan :</label>
						<div class="col-sm-9">
							<select name="kerja_pj_eo" id="kerja_pj_eo" class="form-control">
								<?php  
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea name="alamat_pj_eo" id="alamat_pj_eo" cols="30" rows="10" class="form-control"></textarea>
						</div>
					</div>
					<div class="form-group">
						<label for="jabatan_pj_eo" class="control-label col-sm-3">Jabatan Dalam Organisasi :</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="jabatan_pj_eo" name="jabatan_pj_eo">
						</div>
					</div>
					<div class="form-group">
						<label for="email_register_eo" class="control-label col-sm-3">Email :</label>
						<div class="col-sm-9">
							<input type="email" class="form-control" id="email_register_eo" name="email_register_eo">
						</div>
					</div>
					<div class="form-group">
						<label for="password_register_eo" class="control-label col-sm-3">Password :</label>
						<div class="col-sm-9">
							<input type="password" class="form-control" id="password_register_eo" name="password_register_eo">
						</div>
					</div>
					<div class="form-group">
